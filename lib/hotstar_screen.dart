  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        actions: [Image.asset('assets/hotstar.jpg')],
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage('assets/hotstar.jpg'),
          fit: BoxFit.cover,
        ),
      ),
      child: Container(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              _buildCategoryItem('TV Shows', 'assets/guma.jpg'),
              _buildCategoryItem('Sports', 'assets/sports.jpg'),
        ...
        children: [
          ...
          Container(
            ...
            child: ListView(
              ...
              children: [
                _buildShowItem('Game of Thrones', 'assets/game.jpg'),
                _buildShowItem('Breaking Bad', 'assets/bad.jpg'),
                _buildShowItem('Stranger Things', 'assets/thi.jpg'),
                _buildShowItem('The Office', 'assets/the.jpg'),
                _buildShowItem('MAI', 'assets/web1.jpg')
              ],
            ),
          ),
        ],
