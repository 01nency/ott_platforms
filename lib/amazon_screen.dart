      ...
      children: [
        ...
        Container(
          ...
          child: ListView(
            ...
            children: [
              _buildCategoryItem('Action', 'assets/action.jpg'),
              _buildCategoryItem('Adventure', 'assets/ads.jpg'),
              _buildCategoryItem('Comedy', 'assets/comedy.jpg'),
              _buildCategoryItem('Drama', 'assets/drama.jpg'),
              _buildCategoryItem('Fanstasy', 'assets/fan.jpg'),
              _buildCategoryItem('Thriller', 'assets/thi.jpg'),
            ],
          ),
        )
      ],
